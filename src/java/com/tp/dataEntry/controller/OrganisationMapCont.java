...
import com.tp.dataEntry.model.OrganisationMapModel;
import com.tp.dbcon.DBConnection;
import com.tp.tableClasses.OrganisationMap;
 ...
 /*       HttpSession session = request.getSession(false);
        ...
        try {
          //  organisationMapModel.setConnection(DBConnection.getConnection(ctx, session));
            organisationMapModel.setConnection(DBConnection.getConnection(ctx));
        } catch (Exception e) {
        ...
        try {
            ...
            try {
                ...
                if (JQstring != null) {
                    ...
                    if (JQstring.equals("getOrganization")) {
                        ...
                        list = organisationMapModel.getOrganisation_subType_Name(q,org);
                    }
            ...
            if (requester != null && requester.equals("PRINT")) {
                ...
                jrxmlFilePath = ctx.getRealPath("/report/orgMaplist.jrxml");
