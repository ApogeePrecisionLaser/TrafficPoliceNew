...
import com.tp.dataEntry.model.OrganisationSubTypeModel;
import com.tp.dbcon.DBConnection;
import com.tp.tableClasses.OrganisationSubType;
  ...
  /*      HttpSession session = request.getSession(false);
        ...
        try {
           //  organisationSubTypeModel.setConnection(DBConnection.getConnection(ctx, session));
            organisationSubTypeModel.setConnection(DBConnection.getConnection(ctx));
        } catch (Exception e) {
      ...
      String task = request.getParameter("task");
       ...
       List<OrganisationSubType> organisationSubTypeList=null;
          if(task.equals("generateOrgReport"))
         {
           ...
           String  jrxmlFilePath = ctx.getRealPath("/report/OrganisationSubTypeReport.jrxml");
