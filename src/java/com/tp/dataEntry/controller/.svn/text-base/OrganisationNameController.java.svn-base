...
import com.tp.dataEntry.model.OrganisationNameModel;
import com.tp.dbcon.DBConnection;
import com.tp.tableClasses.OrganisationName;
...
public class OrganisationNameController extends HttpServlet {
   ...
   /*     HttpSession session = request.getSession(false);
     ...
     //       organisationNameModel.setConnection(DBConnection.getConnection(ctx, session));
            organisationNameModel.setConnection(DBConnection.getConnection(ctx));
        } catch (Exception e) {
        ...
        try {
            ...
            if (requester != null && requester.equals("PRINT")) {
                ...
                jrxmlFilePath = ctx.getRealPath("/report/organisationlist.jrxml");
