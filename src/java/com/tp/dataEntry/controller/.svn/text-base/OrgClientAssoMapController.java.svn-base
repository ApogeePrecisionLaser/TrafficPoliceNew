...
import com.tp.dataEntry.model.OrgClientAssoMapModel;
import com.tp.dbcon.DBConnection;
import com.tp.tableClasses.OrgClientAssoMap;
...
public class OrgClientAssoMapController extends HttpServlet {
   ...
   /*     HttpSession session = request.getSession(false);
        ...
        try {
            ...
            orgClientAssoMapModel.setConnection(DBConnection.getConnection(ctx));
        } catch (Exception e) {
