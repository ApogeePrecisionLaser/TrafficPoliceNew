...
import com.tp.dataEntry.model.OrganisationTypeModel;
import com.tp.dbcon.DBConnection;
import com.tp.tableClasses.OrganisationType;
...
public class OrganisationTypeController extends HttpServlet {
    ...
    /*    HttpSession session = request.getSession(false);
        ...
        try {
            ...
            orgTypeModel.setConnection(DBConnection.getConnection(ctx));
        } catch (Exception e) {
        ...
        try {
            ...
            try {
             ...
             if (requester != null && requester.equals("PRINT")) {
                ...
                jrxmlFilePath = ctx.getRealPath("/report/OrganisationTypeList.jrxml");
