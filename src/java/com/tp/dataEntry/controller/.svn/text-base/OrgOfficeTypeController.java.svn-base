...
import com.tp.dataEntry.model.OrgOfficeTypeModel;
import com.tp.dbcon.DBConnection;
import com.tp.tableClasses.OrgOfficeType;
...
public class OrgOfficeTypeController extends HttpServlet {
    ...
    /*    HttpSession session = request.getSession(false);
       ...
       //     orgOfficeTypeModel.setConnection(DBConnection.getConnection(ctx, session));
            orgOfficeTypeModel.setConnection(DBConnection.getConnection(ctx));
        } catch (Exception e) {
        ...
        try {
            ...
            else if(task.equals("generateOrgOfficeReport"))//start from here
         {
            ...
            jrxmlFilePath = ctx.getRealPath("/report/OrganisationOfficeType.jrxml");
