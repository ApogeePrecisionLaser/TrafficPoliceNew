...
import com.tp.dataEntry.model.OrgOfficeModel;
...
public class OrgOfficeController extends HttpServlet {
  ...
  /*      HttpSession session = request.getSession(false);
        ...
        try {
            ...
            organisationModel.setConnection(DBConnection.getConnection(ctx));
        } catch (Exception e) {
        ...
        try {
            ...
            if (requester != null && requester.equals("PRINT")) {
                ...
                jrxmlFilePath = ctx.getRealPath("/report/orgOfficelist.jrxml");
