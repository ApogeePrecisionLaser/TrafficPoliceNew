...
import com.tp.correspondence.model.CorrespondenceStatusModel;
 ...
 * @author jpss
 */
public class CorrespondenceStatusController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        CorrespondenceStatusModel statusTypeModel = new CorrespondenceStatusModel();
        ...
        String searchCorrespondenceType = "";
        ...
        if(task.equals("Search")){
            ...
            searchCorrespondenceType = request.getParameter("searchCorrespondenceType");
        }
        ...
        if (task.equals("Delete")) {
           ...
           CorrespondenceStatusBean statusTypeBean= new CorrespondenceStatusBean();
            statusTypeBean.setCorrespondence_status_id(status_type_id);
           statusTypeBean.setStatus(request.getParameter("status_type"));
           statusTypeBean.setRemark(request.getParameter("remark"));
           String correspondence_type = request.getParameter("correspondence_type");
           if(correspondence_type != null && !correspondence_type.isEmpty())
               statusTypeBean.setCorrespondence_type_id(Integer.parseInt(correspondence_type));
            if (status_type_id == 0) {
        ...
        try {
            ...
            if ( searchCorrespondenceType == null) {
        ...
        noOfRowsInTable = statusTypeModel.getNoOfRows( searchStatusType, searchCorrespondenceType);                  // get the number of records (rows) in the table.
        ...
        if (task.equals("Save") || task.equals("Delete") || task.equals("Save AS New")) {
         ...
         List<CorrespondenceStatusBean> statusTypeList = statusTypeModel.showData(lowerLimit,noOfRowsToDisplay,searchStatusType, searchCorrespondenceType);
        ...
        request.setAttribute("searchCorrespondenceType", searchCorrespondenceType);
        request.setAttribute("IDGenerator", new UniqueIDGenerator());
        request.setAttribute("message", statusTypeModel.getMessage());
        request.setAttribute("correspondenceTypeList", statusTypeModel.getCorrespondenceTypeList());
    request.getRequestDispatcher("/correspondenceStatusView").forward(request, response);
    }
