 ...
 * @author jpss
 */
public class TrafficPoliceSearchBean {
    private int traffic_police_id;
    private String vehicle_no;
    private String offender_name;
    private String offender_license_no;
    ...
    int deposit_amount;
    private String jarayam_no;
    private String[] offence_codeM;
    ...
    public String[] getOffence_codeM() {
        return offence_codeM;
    }

    public void setOffence_codeM(String[] offence_codeM) {
        this.offence_codeM = offence_codeM;
    }
