...
public class TrafficPolice {
    ...
    private String offenceTime_h_m,officer_name, offence_type, vehicle_type, vehicle_no, offender_name, offender_license_no, offence_place, act, 
    ...
    List<TrafficPolice> offenceList;
    ...
    public List<TrafficPolice> getOffenceList() {
        return offenceList;
    }

    public void setOffenceList(List<TrafficPolice> offenceList) {
