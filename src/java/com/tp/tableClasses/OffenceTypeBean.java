...
public class OffenceTypeBean {
    ...
    private String have_second_offence;
    private String second_offence_penalty;

    public String getSecond_offence_penalty() {
        return second_offence_penalty;
    }

    public void setSecond_offence_penalty(String second_offence_penalty) {
        this.second_offence_penalty = second_offence_penalty;
    }
    
    

    public String getHave_second_offence() {
        return have_second_offence;
    }

    public void setHave_second_offence(String have_second_offence) {
        this.have_second_offence = have_second_offence;
    }
