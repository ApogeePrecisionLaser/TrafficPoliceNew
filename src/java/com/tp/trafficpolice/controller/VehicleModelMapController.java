...
public class VehicleModelMapController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("statusTypeList", vehicleModelMapModel.getStatusTypeList());
        request.setAttribute("vehiclemodelTypeList", vehicleModelMapModel.getModelTypeList());
