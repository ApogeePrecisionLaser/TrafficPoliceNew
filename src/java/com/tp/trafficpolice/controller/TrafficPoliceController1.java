 ...
 */
public class TrafficPoliceController1 extends HttpServlet {
        ...
        try {
            ...
            if (task.equals("PRINTRecordList")) {
                ...
                try {
                    ...
                    trafficPolice.setFather_nameM((request.getParameterValues("father_name")));
                    ...
                    if(request.getParameter("process_type").equals("Court")){
                        ...
                        if(receipt_book_no != null && ! receipt_book_no.isEmpty())
                            trafficPolice.setReceipt_book_no(Integer.parseInt(receipt_book_no));
                        ...
                        if(receipt_page_no != null && ! receipt_page_no.isEmpty())
                            trafficPolice.setReceipt_page_no(Integer.parseInt(receipt_page_no));                        
                    }
