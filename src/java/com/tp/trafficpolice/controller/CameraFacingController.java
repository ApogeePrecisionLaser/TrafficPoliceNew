...
import com.tp.trafficpolice.model.CameraFacingModel;
 ...
 * @author Shobha
 */
public class CameraFacingController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CameraFacingModel modeOfPaymentModel = new CameraFacingModel();
        ...
        try {
            ...
            if (JQstring != null) {
                ...
                if (JQstring.equals("getPaymentType")) {
                    list = modeOfPaymentModel.getCameraType(q);
                }
...
//            }
        if (task.equals("Delete")) {
           ...
           CameraFacingBean modeOfPaymentBean= new CameraFacingBean();
            modeOfPaymentBean.setCamera_facing_id(payment_type_id);
           modeOfPaymentBean.setCamera_facing(request.getParameter("payment_type"));
        ...
        if (task.equals("Save") || task.equals("Delete") || task.equals("Save AS New")) {
         ...
         List<CameraFacingBean> statusTypeList = modeOfPaymentModel.showData(lowerLimit,noOfRowsToDisplay,searchPaymentType);
    ...
    request.getRequestDispatcher("/cameraFacing").forward(request, response);
    }
