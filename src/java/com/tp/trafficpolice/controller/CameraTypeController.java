...
import com.tp.trafficpolice.model.CameraTypeModel;
 ...
 * @author Shobha
 */
public class CameraTypeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CameraTypeModel modeOfPaymentModel = new CameraTypeModel();
...
//            }
        if (task.equals("Delete")) {
           ...
           CameraTypeBean modeOfPaymentBean= new CameraTypeBean();
            modeOfPaymentBean.setCamera_type_id(payment_type_id);
           modeOfPaymentBean.setCamera_type(request.getParameter("payment_type"));
        ...
        if (task.equals("Save") || task.equals("Delete") || task.equals("Save AS New")) {
         ...
         List<CameraTypeBean> statusTypeList = modeOfPaymentModel.showData(lowerLimit,noOfRowsToDisplay,searchPaymentType);
    ...
    request.getRequestDispatcher("/cameraType").forward(request, response);
    }
