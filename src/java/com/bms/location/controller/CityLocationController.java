...
import com.bms.location.model.CityLocationModel;
...
public class CityLocationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            cityLocationModel.setConnection(DBConnection.getConnectionForUtf(ctx));
        } catch (Exception ex) {
        ...
        if (task.equals("Delete")) {
            ...
            cityLocationBean.setCity_eng(city_name_eng);
        ...
        request.getRequestDispatcher("/cityLocatView").forward(request, response);
    }
