...
import com.bms.location.tableClasses.AreaTypeBean;
...
public class AreaTypeModel {
    ...
    public List<String> getZoneName(String q) {
        ...
        try {
            ...
            while (rset.next()) {    // move cursor from BOR to valid record.
                String zone_name = uk.Convert_to_Kritidev_010(rset.getString("zone"));
    ...
    public int getNoOfRows(String area_name, String ward, String zone) //, String ward_no, String city_name
    {
        ...
        int noOfRows = 0;
        try {
            String query = " SELECT COUNT(area_id) as area_id FROM area as a,ward as w,zone_new as z "
                    + " where a.ward_id=w.ward_id and w.zone_new_id=z.zone_new_id "
    ...
    public List<AreaTypeBean> showData(int lowerLimit, int noOfRowsToDisplay, String area_name, String ward, String zone) {
        ...
        String query = " SELECT a.area_id,z.zone,w.ward_name,a.area_name,a.area_no,a.description "
                + " FROM area as a, ward as w, zone_new as z "
                + " where a.ward_id=w.ward_id and w.zone_new_id=z.zone_new_id "
                + " and IF('" + area_name + "'='',a.area_name LIKE '%%',a.area_name=?)  "
                + " and IF('" + ward + "'='',w.ward_name LIKE '%%',w.ward_name =?) "
                + " and IF('" + zone + "'='',z.zone LIKE '%%',z.zone=?) order by zone,ward_name,area_no "
        ...
        try {
            ...
            while (rset.next()) {
                ...
                bean.setZone_name(rset.getString("zone"));
    ...
    public List<AreaTypeBean> showAllData(String area_name, String ward, String zone) {
        ...
        zone = ku.convert_to_unicode(zone);
        List<AreaTypeBean> list = new ArrayList<AreaTypeBean>();
        String query = " select z.zone, w.ward_name,a.area_name,a.area_no,a.description FROM area as a,ward as w,zone_new as z "
                + "    where a.ward_id=w.ward_id and w.zone_new_id=z.zone_new_id "
                + " and IF('" + area_name + "'='',a.area_name LIKE '%%',a.area_name=?)  "
                + " and IF('" + ward + "'='',w.ward_name LIKE '%%',w.ward_name =?) "
                + " and IF('" + zone + "'='', z.zone LIKE '%%', z.zone=?) ";
        try {
            ...
            while (rset.next()) {
                ...
                bean.setZone_name(uk.Convert_to_Kritidev_010(rset.getString("zone")));
                bean.setRemark(rset.getString("description"));
                list.add(bean);
            }
        } catch (Exception e) {
    ...
    public int updateRecord(AreaTypeBean areaTypeBean) {
        ...
        try {
            ...
            pstmt.setString(1, ku.convert_to_unicode(areaTypeBean.getArea_name()));
