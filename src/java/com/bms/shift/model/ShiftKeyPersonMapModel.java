...
import com.bms.shift.tableClasses.ShiftKeyPersonMapBean;
...
public class ShiftKeyPersonMapModel {
    ...
    public static List<ShiftKeyPersonMapBean> showData(int lowerLimit, int noOfRowsToDisplay, String location_type, String search_shift_type, String search_designation, String searchCityName, String searchZoneName, String searchWardName, String searchAreaName, String searchperson, String searchdate, String emp_code) {
        ...
        String query = "Select skpm.shift_key_person_map_id,st.shift_type,d.designation,lt.location_type_name,z.zone,z.zone_no,w.ward_name,w.ward_no,a.area_name,a.area_no,cl.location,cl.location_no,kp.key_person_name,kp.emp_code,skpm.date,skpm.remark "
                + " from shift_key_person_map as skpm "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                skpm.setZone(unicodeToKruti.Convert_to_Kritidev_010(rs.getString("zone")));
    ...
    public static void getName(ShiftKeyPersonMapBean skpm, String location_type, String ward, String area, String location) {
        String query = "";
        if (location_type.equals("city_location")) {
            query = "select z.zone,z.zone_no,w.ward_name,w.ward_no,a.area_name,a.area_no from city_location as cl,zone_new as z,ward as w,area as a"
...
try {
    ...
    public static List<String> getZone(String q, String zone_no) {
        List<String> list = new ArrayList<String>();
        String query = " SELECT zone FROM zone_new as z "
                // + " where sdlm.designation_location_type_id=dlt.designation_location_type_id and dlt.zone_id=z.zone_id "
                + " where  IF('" + zone_no + "'='', zone_no like '%%', zone_no ='" + zone_no + "') group by zone ";
        try {
            ResultSet rset = connection.prepareStatement(query).executeQuery();
            int count = 0;
            q = q.trim();
    ...
    public static List<String> getlocation(String q, String area, String ward, String zone, String location_no) {
        ...
        String query = " SELECT cl.location "
                + " FROM area AS a ,ward AS w, zone_new AS z,city_location as cl,shift_designation_location_map as sdlm,designation_location_type as dlt  "
   ...
   // public static List<String> getperson_code(String q){
