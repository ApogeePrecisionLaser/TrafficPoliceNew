...
import com.bms.shift.model.ShiftDesignationLocationModel;
        ...
        try {
            ...
            if (JQstring != null) {
                ...
                if (JQstring.equals("getZone")) {
                    ...
                    list = ShiftDesignationLocationModel.getLocationType(q);
                }
        ...
        try {
            ...
            if (task.equals("Delete")) {
                ...
                if (task.equals("Save AS New")) {
                 ...
                 shift_type = request.getParameter("shift_type");
            ...
            request.setAttribute("shift_type", shift_type);
            request.setAttribute("designation",designation);
            request.setAttribute("searchlocation_type", searchlocation_type);
            
            request.setAttribute("locationList", ShiftDesignationLocationModel.getLocationType());
