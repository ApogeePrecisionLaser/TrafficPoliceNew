...
//            $("#location_type").autocomplete("ShiftDesinationLocationController", {
//            extraParams: {
...
function verify() {
                ...
                if(clickedButton == 'save' || clickedButton == 'Save AS New') {
                    ...
                    if(myLeftTrim(location_type).length == 0) {
                        $("#message").html("<td colspan='6' bgcolor='coral'><b> Location Type is required...</b></td>");
                 ...
                 <c:when test="${showPrevious == 'false'}">
                  ...
                  <input  type="hidden" name="searchZone" value="${searchZone_no}">
                   <input  type="hidden" name="searchlocation_type" value="${searchlocation_type}">
                      ...
                      <form  action="ShiftDesinationLocationController" method="post" onsubmit="return verify()">
                          <table  align="center"  class="content" border="1">
                             ...
                             <tr>
                                 ...
                                 <th class="heading1"> Shift Type <span class="required_field_class">*</span></th>
                                 <td><input type="text" class="new_input" id="shift_type"  name="shift_type" value="${shift_type}" disabled></td>
                                 <th class="heading1"> Designation <span class="required_field_class">*</span></th>
                              <td><input type="text" class="new_input" id="designation" name="designation" value="${designation}" disabled></td>
                              </tr>
                              <tr>
...
<!--                                    <option value="">Select</option>
                               ...
                               <option value="area">Area</option>
                                ...
                                <c:forEach var="vehiclemodelTypeList" items="${locationList}">
                                <option value="${vehiclemodelTypeList}"> ${vehiclemodelTypeList}</option>
                                </c:forEach>
                                 </select>
                              ...
                              <tr>
                                      <th class="heading1" >Zone Name<span id="zone_class" class="required_field_class">*</span></th>
                                    ...
                                    <th class="heading1"  >Ward Name<span id="ward_class" class="required_field_class">*</span></th>
                              ...
                              <tr>
                               <th class="heading1">Area Name<span id="area_class" class="required_field_class">*</span></th>
                              ...
                              <th class="heading1">City Location Name<span id="city_location_class" class="required_field_class">*</span></th>
                              <td><input type="text" class="new_input"  id="location"  size="10" style="display: none" name="location" value="" disabled>
                               ...
                               <tr>
                              <th class="heading1">No Of Person <span class="required_field_class">*</span></th>
