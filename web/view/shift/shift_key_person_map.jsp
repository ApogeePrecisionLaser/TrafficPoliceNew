...
function verify() {
                ...
                if(clickedButton == 'save' || clickedButton == 'Save AS New') {
                    ...
                    if(myLeftTrim(person).length == 0) {
                        $("#message").html("<td colspan='6' bgcolor='coral'><b>Person Name is required...</b></td>");
                        document.getElementById("person").focus();
                        return false;
                    }
                    if(myLeftTrim(date).length == 0) {
                        $("#message").html("<td colspan='6' bgcolor='coral'><b>Date is required...</b></td>");
              ...
              <c:otherwise>
               <input class="button" type='submit' name='buttonAction' value='First'>
                 ...
                 <input  type="hidden" name="emp_code" value="${emp_code}">
                      ...
                      <form  action="ShiftKeyPersonMapController" method="post" onsubmit="return verify()">
                          <table  align="center" class="content" border="1">
                             ...
                             <input type="text"  id="person_code"  size="5"  name="person_code" placeholder='code'  value="" disabled></td>
                              ...
                              <tr>
                              <th class="heading1">Date <span class="required_field_class">*</span></th>
