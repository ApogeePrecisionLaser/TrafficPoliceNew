...
//                  function city_name_focusOut(){
//                      //alert("focusout");
//                      var sheetToBeRemoved = doc.getElementsByClassName("ac_results");
...
//                    $("#offender_city").click(cssFunction);
                    $("#searchActType").click(cssFunction);
                    $("#searchVehicleType").click(cssFunction);
                    $("#searchVehicleNo").click(cssFunction);
//                    $("#zone").keyup(function(){
//                        $(".ac_results li").load(cssFunction);
//                    });
//                    $("#zone").keydown(cssFunction)
...
//                    });
                    ...
                    $("#reciept_book_no").result(function(event, data, formatted){
                ...
                $("#reciept_page_no").result(function(event, data, formatted){//debugger;
                    $("#deposited_amount").focus();
                });
                ...
                function makeEditable(id) {
                    ...
                    doc.getElementById("vehicle_no_state").disabled=false;
                    doc.getElementById("vehicle_no_city").disabled=false;
                    doc.getElementById("vehicle_no_series").disabled=false;
...
//                    doc.getElementById("offender_city").disabled = false;
                    ...
                    // doc.getElementById("act_origin").readOnly=true;
                      ...
                      if(id == 'NEW') {
                        ...
                        //alert("3");
//                        doc.getElementById("vehicle_no_state").value ="MP";
//                        doc.getElementById("vehicle_no_city").value ="07";
//                        doc.getElementById("vehicle_no_series").value ="R";
                        //alert("4");
                ...
                <%-- holds the id of the column being clicked, excluding the prefix t1c e.g. t1c3 (column 3 of table 1). --%>
                        ...
                        doc.getElementById("receipt_book_id").value= doc.getElementById("receipt_book_id"+rowNum).value;
                        var x= doc.getElementById("traffic_police_id").value;
                        alert("traffic_police_id====LineNo 557==="+x);
...
//                        alert(offence_date);
    ...
    //datePlus = doc.getElementById("complaint_date").value;
                        ...
                        doc.getElementById("time_h").value = offence_h;
                        doc.getElementById("time_m").value = offence_m;
                        

                        doc.getElementById("vehicle_no_state").value = doc.getElementById("vehicle_no_state"+rowNum).value;
                        doc.getElementById("vehicle_no_city").value = doc.getElementById("vehicle_no_city"+rowNum).value;
                        doc.getElementById("vehicle_no_series").value = doc.getElementById("vehicle_no_series"+rowNum).value;
                        doc.getElementById("vehicle_no").value = doc.getElementById("vehicle_no_digits"+rowNum).value;//doc.getElementById(t1id +(lowerLimit+6)).innerHTML;
                        ...
                        alert("no_of_offence="+no_of_offence);
                           ...
                           var offenceCodeValues = $("#offenceCodeValues").val("");
                                ...
                                for(var i = 0;i < no_of_offence;i++){
                                    ...
                                    if(myLeftTrim(offence_code).length == 0) {
                                        ...
                                        offenceCodeValues = offenceCodeValues + "," + offence_code;
                                    }
                                }
...
//    selectedVal = selected.val();//}
                    ...
                    function getRecordlist(id){
                        ...
                        var searchReceiptBookNo = doc.getElementById("searchReceiptBookNo").value;
                        if(id == "view_pdf")
                        ...
                        var url = "trafficPoliceCont?" + queryString + "&searchOfficerName="+searchOfficerName+"&searchBookNo="+searchBookNo+
                            ...
                            "&searchVehicleNo="+searchVehicleNo+"&searchFromDate="+searchFromDate+"&searchToDate="+searchToDate+"&searchJarayamNo="+searchJarayamNo+"&searchOffenceCode="+searchOffenceCode+"&searchReceiptBookNo="+searchReceiptBookNo;
...
//                        createEditableSelect(doc.forms[0].myText);
        ...
        function removeSpace(id){
           ...
           $.trim($("#"+id).val('')); //to set it blank
              ...
              s2 = s.trim();
              //alert(s2.length);
              doc.getElementById(id).value=s2;
                            ...
                            <table align="center" width="450">
                                <tr>
                                    <td colspan="5">
                                        <table width="100%">
                                            <tr>
                                                <td class="header_table" colspan="2" align="center"><h1>Traffic Police</h1></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                            ...
                                            <table  align="center"  class="heading1">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <input type="button" id="view_pdf" class="pdf_button" name="view_pdf" value="PDF" onclick="getRecordlist(id)">
                                                    ...
                                                    <c:forEach var="tp" items="${requestScope['list']}" varStatus="loopCounter">
                                                        <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                            <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}
                                                                ...
                                                                <input type="hidden" id="receipt_book_id${loopCounter.count}" value="${tp.receipt_book_id}">
                                                                <input type="hidden" id="vehicle_no_state${loopCounter.count}" value="${tp.vehicle_no_state}">
                                                                <input type="hidden" id="vehicle_no_city${loopCounter.count}" value="${tp.vehicle_no_city}">
                                                                <input type="hidden" id="vehicle_no_series${loopCounter.count}" value="${tp.vehicle_no_series}">
                                                                <input type="hidden" id="vehicle_no_digits${loopCounter.count}" value="${tp.vehicle_no_digits}">
                                                            ...
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)"  class="new_input" style="" width="90%">${tp.key_person_name}</td>
                                                            ...
                                                            <td id="t1c${IDGenerator.uniqueID}"  class="new_input" onclick="fillColumns(id)">${tp.zone}</td>
                                                        ...
                                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                                            ...
                                                            <tr class="heading">
                                                                ...
                                                                <b class="heading1" >Jarayam No.:</b>
                                                                    <input class="input" type="text" id="jarayam_no" name="jarayam_no" value="" size="20" disabled>
...
<!--                                                                <td>
                                                                    <input class="input" type="text" id="vehicle_no_state" name="vehicle_no_state" value="${vehicle_no_state}" size="2" maxlength="2" onkeyup="getFocusNextField(id);" disabled required>
                                                                    <input class="input" type="text" id="vehicle_no_city" name="vehicle_no_city" value="${vehicle_no_city}" size="2" maxlength="2" onkeyup="getFocusNextField(id);" disabled required>
                                                                    <input class="input" type="text" id="vehicle_no_series" name="vehicle_no_series" value="" size="4" maxlength="5" onkeyup="getFocusNextField(id);" disabled required>
                                                                 ...
                                                                 <td>
                                                                    <input class="input" type="text" id="vehicle_no_state" name="vehicle_no_state" value="${vehicle_no_state}" size="2" maxlength="2" onkeyup="removeSpace(id);" disabled required>
                                                                    <input class="input" type="text" id="vehicle_no_city" name="vehicle_no_city" value="${vehicle_no_city}" size="2" maxlength="2" onkeyup="removeSpace(id);" disabled required>
                                                                    <input class="input" type="text" id="vehicle_no_series" name="vehicle_no_series" value="" size="4" maxlength="5" onkeyup="removeSpace(id);" disabled required>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><textarea class="input"  id="offender_address" name="offender_address" rows='6' cols='40' value="" size="40" disabled></textarea></td>
                                                            </tr>
                                                            <tr>
<!--                                                                <th class="heading1"> City : </th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan=""><input class="input new_input" type="text" id="zone" name="zone" value="${zone}" size="10" disabled required></td>
                                                            ...
                                                            <tr class="receipt_book">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input class="input" type="hidden" id="receipt_book_id" name="receipt_book_id" value="0" size="10" onclick="">
                                                                </td>
