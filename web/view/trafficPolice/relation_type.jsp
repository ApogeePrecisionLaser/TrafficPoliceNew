...
<html>
    <head>
        ...
        <title>Case Status Detail</title>
        ...
        <script type="text/javascript" language="javascript">
          ...
          jQuery(function(){
        $("#searchRelationtype").autocomplete("relationTypeCont.do", {
            extraParams: {
                action1: function() { return "getRelationtype"}
            }
        });
        var cssFunction = function(){
         ...
         $("#searchRelationtype").click(cssFunction);
    });
                ...
                try{
                    ...
                    if(doc.getElementById("clickedButton").value == 'Save' || doc.getElementById("clickedButton").value == 'Save As New' || doc.getElementById("clickedButton").value == 'Update') {
                        ...
                        if(myLeftTrim(query_type).length == 0) {
                            ...
                            $("#message").html("<td colspan='2' bgcolor='coral'><b>Relation Type  is required...</b></td>");
                            doc.getElementById("query_type1").focus();
 ...
 var popupwin = null;
    function displayMapList(id){
        ...
        var url = "relationTypeCont.do?"+queryString;
                    ...
                    <div class="maindiv" id="body" >
                        <table width="100%">
                            <tr>
                                 ...
                                 <td align="center" class="header_table" width="90%"><b>Relation Type</b></td>
                           ...
                           <tr>
                            <td> <div align="center">
                                    <form name="form0" method="post" action="relationTypeCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>

                                                <th>Relation type </th>
                                                <td><input class="input new_input" type="text" id="searchRelationtype" name="searchRelationtype" value="${searchRelationtype}" size="30" ></td>
                                            ...
                                            <table id="table1" align="center" class="content" width="500">
                                                ...
                                                <c:forEach var="dd" items="${requestScope['queryTypeList']}" varStatus="loopCounter">
                                                    <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)">${dd.query_type}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)">${dd.description}</td>
                                                    </tr>
                                                </c:forEach>
                                                <tr>
                                             ...
                                             <input  type="hidden" name="searchRelationtype" value="${searchRelationtype}" size="30" >
                                            </table></DIV>
                                    </form>
                            ...
                            <tr>                    <td align="center">
                                    <DIV id="autoCreateTableDiv" STYLE="visibility: hidden;height: 0px ;margin-bottom: 10px">
                                        <form name="form3"  action="relationTypeCont.do" method="post" >
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <div>
                                        <form name="form2" id="form2" method="POST" action="relationTypeCont.do" onsubmit="return verify()">
                                            <table border="0" id="table2" align="center" class="reference" width="500">
                                                ...
                                                <tr>
                                                    <th class="heading1">Relation Type<span class="required_field_class">*</span></th>
                                                    <td>
                                                        <input type="hidden" id="query_type_id" name="query_type_id" value="0">

                                                        <input class="input new_input" type="text" id="query_type1" name="query_type" value="" size="40" >
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="heading1">Description</th>
                                                    <td>
                                                        <input class="input new_input" type="text" id="description" name="description" value=""  size="40"  >
                                                    </td>
                                                </tr>
                                                <tr>
