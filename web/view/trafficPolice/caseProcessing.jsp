...
//                            $(this).closest('form').get(0).reset();
                    ...
                    $("#searchOfficerName").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                   ...
                   var actOriginList =  $("#act_origin"+actOriginId).autocomplete("caseProcessingCont.do", {
                        extraParams: {
                    ...
                    $("#searchJarayamNo").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                            action1: function() { return "getJarayamNo";}
                        }
                    });

                    $("#searchOffenceCode").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                            action1: function() { return "getOffenceCode";}
                        }
                    });

                    $("#searchBookNo").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                    ...
                    $("#searchOffenceType").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                    ...
                    $("#searchActType").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                    ...
                    $("#searchVehicleType").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                    ...
                    $("#searchVehicleNo").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                    ...
                    $("#searchFromDate").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                            action1: function() { return "getFromDateList"}
                        }
                    });
                    $("#searchToDate").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                    ...
                    $("#city_name").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                            action1: function() { return "getCityName"}
                        }
                    });
                    $("#zone").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                            action1: function() { return "getZoneName"},
                            action2: function(){return doc.getElementById("city_name").value ;}

                        }
                    });$("#offence_place").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                            action1: function() { return "getLocationName"},
                            action2: function(){return doc.getElementById("zone").value ;}

                        }
                    });
                     $("#offender_city").autocomplete("caseProcessingCont.do", {
                        extraParams: {
                ...
                function makeEditable(id) {
                    ...
                    doc.getElementById("case_no").disabled = false;
                    doc.getElementById("case_date").disabled = false;
                    doc.getElementById("case_status").disabled = false;
                    ...
                    if(id == 'NEW') {
                        ...
                        setDefaultColor(doc.getElementById("noOfRowsTraversed").value, 24);
                ...
                <%-- holds the id of the column being clicked, excluding the prefix t1c e.g. t1c3 (column 3 of table 1). --%>
                        ...
                        doc.getElementById("case_status").value = doc.getElementById(t1id +(lowerLimit+28)).innerHTML;
                    ...
                    function trafficPoliceVerify(){//debugger;
                        try{
                           ...
                           var id;
                            ...
                            if(clickedButton == 'Save' || clickedButton == 'Save As New' || clickedButton == 'Cancel') {
                                //alert(doc.getElementById("clickedButton").value);
...
//                                    $("#message").html("<td colspan='6' bgcolor='coral'><b>vehicle  no is required...</b></td>");
...
//                                }
                                ...
                                if(myLeftTrim(offender_license_no).length == 0 && myLeftTrim(vehicle_no).length == 0) {
                    ...
                    function IsNumeric(id) {
                        ...
                        for (i = 0; i < strString.length && blnResult == true; i++)
                        {
                            ...
                            if (strValidChars.indexOf(strChar) == -1)
                            {
                                ...
                                $("#message").html("<td colspan='8' bgcolor='coral'><b>Time should be Numeric </b></td>");
                                blnResult = false;
                            }else{
...
//                            $("#selectByBookNo").attr("style","visibility:visible");
                    ...
                    function RecieptNo() {
                        ...
                        if(reciept_no==doc.getElementById("book_no").value)
                        {

                            $.ajax({url: "trafficPoliceCont", async: false ,data: "action1=getRecieptNo&reciept_no="
                                    + reciept_no , success: function(response_data) {
                                    //alert(response_data);
                                    $("#msg").html("");
...
//    selectedVal = selected.val();//}
                    ...
                    function getRecordlist(){
                        ...
                        var queryString = "task=PRINTRecordList";
                        var url = "caseProcessingCont.do?" + queryString + "&searchOfficerName="+searchOfficerName+"&searchBookNo="+searchBookNo+
    ...
    table.removeChild(doc.getElementById("Act_type"+id));
                    ...
                    function makeStructureDiv() {
                       ...
                       /* var element2 = doc.createElement("input");
                        ...
                        //element2.type = "text";
                        element2.name = "act_origin";
                        element2.id = "act_origin"+rowCount;
                        element2.disabled = true;//element1.size = 1;
            ...
            function getOffenctCode(count){
                var act_origin = $("#act_origin"+count).val();
                var queryString = "task=getOffenceCode";
                        var url = "trafficPoliceCont?" + queryString + "&act_origin="+act_origin+"&count="+count;
                            ...
                            <table align="center" width="450">
                                <tr>
                                    <td colspan="5">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td class="header_table" colspan="2" align="center"><h1>Case Processing</h1></td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td  align="center">
                                        <form name="form0" method="post" action="caseProcessingCont.do">
                                            <table  align="center"  class="heading1">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        Vehicle Type
                                                        <input class="input" type="text" id="searchVehicleType" name="searchVehicleType" value="${searchVehicleType}" size="30" >
                                                ...
                                                <tr>
                                                    <td>
                                                        From Date
                                                        <input class="input" type="text" id="searchFromDate" name="searchFromDate" value="${searchFromDate}" size="30" >

                                                        To Date
                                                        <input class="input" type="text" id="searchToDate" name="searchToDate" value="${searchToDate}" size="30" >
                                                        Offender License No.
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <input type="button" id="view_pdf" class="pdf_button" name="view_pdf" value="" onclick="getRecordlist()">
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
                                ...
                                <tr>
                                    <td align="center">
                                        <div class="content_div" style="max-height: 375px">
                                            <form name="form1" action="caseProcessingCont.do" method="post">
                                                <table id="table1" border="1" align="center" class="content" width="980">
                                                    ...
                                                    <c:forEach var="tp" items="${requestScope['list']}" varStatus="loopCounter">
                                                        <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                            ...
                                                            <td id="t1c${IDGenerator.uniqueID}" class="new_input"  onclick="fillColumns(id)"  style="white-space: normal" width="90%">${tp.offender_name}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)"  style="white-space: normal" width="90%">${tp.father_name}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${tp.offender_age}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)">${tp.offender_address}</td><!--class="new_input"-->
                                                            ...
                                                            <td id="t1c${IDGenerator.uniqueID}" style="display: none"  onclick="fillColumns(id)">${tp.case_status}</td>
                                ...
                                <tr>
                                    <td align="center">
                                        <DIV id="autoCreateTableDiv"  STYLE="visibility: hidden;height: 0px ;margin-bottom: 10px;overflow: auto;width: 990px">
                                            <form name="form2"  action="caseProcessingCont.do" method="post" >
                                                ...
                                                <input  type="hidden" name="searchdocName" value="${searchdocName}"  >
                                ...
                                <tr>
                                    <td align="center">
                                        <form name="form3"  id="form3" action="caseProcessingCont.do" method="post" onsubmit="return trafficPoliceVerify()">
                                            <table id="table" class="reference"  align="center" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="selectByTd" width="80%">
                                                        ...
                                                        <input type="radio" id="select_challan_no" name="selectBy"value="Echallan"  onchange="showSelectedDiv(id);" >E-Challan
                                                    ...
                                                    <td colspan="2">
                                                        <table id="selectByOfficerName_table" width="90%">
                                                            <tr >
                                                                ...
                                                                <td width="30%">
                                                                    <select class="dropdown" id="officer_name_selected" name="officer_name_selected" onchange="fill_OfficerName()" style="width: 70%"  >
                                                                        <option value="Select officer Name" style="color: red" Selected>Select officer Name</option>
                                                ...
                                                <tr id="selectByBookNo" style="display: none">
                                                    <td colspan="2">
                                                        <table id="selectByBookNo_table"width="90%">
                                                            <tr>
                                                                <th class="heading" width="20%">Book No</th>
                                                                <td width="20%">
                                                                    <select class="dropdown" id="book_no_selected" name="book_no"  onchange="fill_BookNo()" style="width: 70%">
                                                                        <option value="Select Book No" style="color: red" selected>Select Book No</option>
                                                    ...
                                                    <div>
                                                        ...
                                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input class="input new_input" type="text" id="offender_name" name="offender_name" value="" size="25" disabled required>
                                                                </td>
                                                                <th class="heading1">Father's Name</th>
                                                                <td>
                                                                    <input class="input new_input" type="text" id="father_name" name="father_name" value="" size="25" disabled>
                                                                </td>  
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td><input class="input new_input" type="text" id="offender_address" name="offender_address" value="" size="40" disabled></td>
                                                            </tr>
                                                            <tr>
                                                                <th class="heading1"> City : </th>
                                                                <td>
                                                                    <input class="input new_input" type="text" id="offender_city" name="offender_city" value="" size="20" disabled>
                                                                </td>
                                                                <th class="heading1">Offence City </th>
                                                                <td><input class="input new_input" type="text" id="city_name" name="city_name" value="${offence_city}" size="30" disabled required></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input class="input new_input" type="text" id="offence_place" name="offence_place" value="${offence_place}" size="25" disabled required>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr id="court_case" style="visibility: collapse">
                                                            ...
                                                            <tr id="court_case1" style="visibility: collapse">

                                                                <th class="heading1">Relative Name</th>
                                                                <td>
                                                                    <input class="input new_input" type="text" id="relative_name" name="relative_name" value="" size="40" disabled>
                                                                </td>                                                                
                                                            </tr>
                                                            ...
                                                            <tr id="court_case3" style="visibility: collapse">
                                                                ...
                                                                <td>
                                                                    <input class="input" type="text" id="case_date" name="case_date" value="" size="40" disabled>
                                                                </td>
                                                            ...
                                                            <tr>                                                                
                                                                <th class="heading1">Deposited Amount(in court) </th><td><input class="input" type="text" id="deposited_amount" name="deposited_amount" value="" size="40" disabled></td>
                                                            </tr>
                                                            <tr>
                                                               <!-- <th class="heading1">Act Origin</th>
                                                               ...
                                                               <th class="heading1">Case Status</th>
                                                               <td>
                                                                    <select class="dropdown3" id="case_status" name="case_status" disabled>
                                                                        <option value="" style="color: red" selected>Select</option>
