<%-- 
    ...
    Created on : Mar 25, 2019, 12:05:16 PM
    Author     : Shobha
--%>
...
//                    });
                 ...
                 $("#searchPaymentType").focus(function(){
                    //alert("vivek");
...
//                $("span").css("display", "inline").fadeOut(2000);
    ...
    jQuery(function(){
        $("#searchPaymentType").autocomplete("ModeOfPaymentCon.do", {
            extraParams: {
                action1: function() { return "getPaymentType"}
            }
        });
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(payment_type).length == 0) {

                document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Organisation Type Name is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Payment Type Name is required...</b></td>");
                document.getElementById("payment_type").focus();
    ...
    function fillColumns(id) {
        ...
        document.getElementById("payment_type_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("payment_type").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Mode Of Payment</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="post" action="ModeOfPaymentCon.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Payment Type</th>
                                                <td><input class="input" type="text" id="searchPaymentType" name="searchPaymentType" value="${searchPaymentType}" size="30" ></td>
...
<!--                                                <td><input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList(id)"></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="post" action="ModeOfPaymentCon.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                <th class="heading">S.No.</th>
                                                <th class="heading">Payment type</th>
                                            ...
                                            <c:forEach var="statusTypeBean" items="${requestScope['statusTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${statusTypeBean.payment_type_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${statusTypeBean.payment_type}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="ModeOfPaymentCon.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Payment Type<span class="required_field_class">*</span></th>
                                                <td>
                                                    <input class="input" type="hidden" id="payment_type_id" name="payment_type_id" value="" >
                                                    <input class="input" type="text" id="payment_type" name="payment_type" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
