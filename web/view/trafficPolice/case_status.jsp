...
<html>
    <head>
        ...
        $("#searchCaseStatus").focus(function(){
                    //alert("vivek");
...
//                $("span").css("display", "inline").fadeOut(2000);
           ...
           jQuery(function(){
        $("#searchCaseStatus").autocomplete("caseStatusCont.do", {
            extraParams: {
                action1: function() { return "getCaseStatusList"}
                }
        });
           });
                ...
                try{
                    ...
                    if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save As New' || document.getElementById("clickedButton").value == 'Update') {
                        ...
                        if(myLeftTrim(query_type).length == 0) {
                            ...
                            $("#message").html("<td colspan='2' bgcolor='coral'><b>Case Status is required...</b></td>");
                            document.getElementById("query_type1").focus();
 ...
 var popupwin = null;
    function displayMapList(id){
        ...
        var url = "caseStatusCont.do?"+queryString;
                    ...
                    <div class="maindiv" id="body" >
                        <table width="100%">
                            <tr>
                                 ...
                                 <td align="center" class="header_table" width="90%"><b>Case Status Detail</b></td>
                           ...
                           <tr>
                            <td> <div align="center">
                                    <form name="form0" method="post" action="caseStatusCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>

                                                <th>Case Status </th>
                                                <td><input class="input" type="text" id="searchCaseStatus" name="searchCaseStatus" value="${searchCaseStatus}" size="30" ></td>
                                            ...
                                            <table id="table1" align="center" class="content" width="500">
                                                ...
                                                <c:forEach var="dd" items="${requestScope['queryTypeList']}" varStatus="loopCounter">
                                                    <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" class=""  onclick="fillColumns(id)">${dd.query_type}</td>
                            ...
                            <tr>                    <td align="center">
                                    <DIV id="autoCreateTableDiv" STYLE="visibility: hidden;height: 0px ;margin-bottom: 10px">
                                        <form name="form3"  action="caseStatusCont.do" method="post" >
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <div>
                                        <form name="form2" id="form2" method="POST" action="caseStatusCont.do" onsubmit="return verify()">
                                            <table border="0" id="table2" align="center" class="reference" width="500">
                                                ...
                                                <tr>
                                                    <th class="heading1">Case Status<span class="required_field_class">*</span></th>
                                                    <td>
