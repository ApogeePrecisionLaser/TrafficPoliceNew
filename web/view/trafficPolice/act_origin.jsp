...
//                $("span").css("display", "inline").fadeOut(2000);
    ...
    jQuery(function(){
        $("#searchActOrigin").autocomplete("actOriginCont", {
            extraParams: {
    ...
    function makeEditable(id) {
        ...
        if(id == 'new') {
            ...
            $("#message").html("");
            document.getElementById("act_origin_id").value = "";
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(act_origin).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Act Origin is required...</b></td>");
                document.getElementById("act_origin").focus();
    ...
    function fillColumns(id) {
        ...
        document.getElementById("act_origin_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
    ...
    function displayMapList(id){
        ...
        var queryString ;
        if(id=='viewPdf')
         queryString = "task=generateMapReport&searchActOrigin="+searchActOrigin;
        else
        queryString = "task=generateMapXlsReport&searchActOrigin="+searchActOrigin;
        var url = "actOriginCont?"+queryString;
        popupwin = openPopUp(url, "ActOrigin Type Map Details", 500, 1000);
    }
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>ACT ORIGIN</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="post" action="actOriginCont">
                                        <table align="center" class="heading1" width="700">
                                            <tr>
                                                ...
                                                <td><input class="pdf_button" type="button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList(id);"/>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="post" action="actOriginCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="actOrigin" items="${requestScope['actoriginList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    <%--  <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">
                                                          <input type="hidden" id="act_origin_id${loopCounter.count}" value="${statusTypeBean.act_origin_id}">${lowerLimit - noOfRowsTraversed + loopCounter.count}
                                                          <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                      </td> --%>

                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${actOrigin.act_origin_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${actOrigin.act_origin}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${actOrigin.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="searchActOrigin" name="searchActOrigin" value="${searchActOrigin}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="actOriginCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="act_origin_id" name="act_origin_id" value="" >
                                                    <input class="input new_input" type="text" id="act_origin" name="act_origin" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <input type="hidden"  name="searchActOrigin" value="${searchActOrigin}" >
                                        </table>
                                    </form>
                                </div>
                            </td>
