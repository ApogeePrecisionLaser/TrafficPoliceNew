...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#makeType").autocomplete("makeTypeCont", {
            extraParams: {
        ...
        var cssFunction = function(){
         ...
         $("#makeType").click(cssFunction);
    });
    
    $(document).ready(function(){
        
        $("#makeType").focus(function(){
                    //alert("vivek");
...
//                $("span").css("display", "inline").fadeOut(2000);
    ...
    function makeEditable(id) {
        ...
        if(id == 'new') {
            ...
            $("#message").html("");
            document.getElementById("make_type_id").value = "";
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(make_type).length == 0) {
                ...
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Vehicle Made By Name is required...</b></td>");
                document.getElementById("make_type").focus();
    ...
    function fillColumns(id) {
        ...
        document.getElementById("make_type_id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
    ...
    function displayMapList(id){
        ...
        var url = "makeTypeCont?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Vehicle Made By</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="post" action="makeTypeCont">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Vehicle Made By</th>
                                                <td><input class="input" type="text" id="makeType" name="makeType" value="${makeType}" size="30" ></td>
                                                ...
                                                <%-- <td><input class="button" type="submit" name="task" id="read" value="Read Excel Data"></td>--%>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="makeTypeCont">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="makeTypeBean" items="${requestScope['makeTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    <%--  <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">
                                                          <input type="hidden" id="make_type_id${loopCounter.count}" value="${makeTypeBean.make_type_id}">${lowerLimit - noOfRowsTraversed + loopCounter.count}
                                                          <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                      </td> --%>

                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${makeTypeBean.make_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${makeTypeBean.make}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${makeTypeBean.remark}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                            ...
                                            <input  type="hidden" id="makeType" name="makeType" value="${makeType}" >
                                        </table></DIV>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="makeTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="make_type_id" name="make_type_id" value="" >
