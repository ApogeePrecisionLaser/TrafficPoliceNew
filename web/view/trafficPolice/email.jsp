...
//                $("span").css("display", "inline").fadeOut(2000);
    ...
    jQuery(function(){
                    ...
                    debugger;
                    $("#searchEmail").autocomplete("EmailController", {
                        extraParams: {

                            action1: function() { return "getEmail";}
                        }
                    });
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if(myLeftTrim(status_type).length == 0) {
                ...
                document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Sender Email is required...</b></td>";
    ...
    function fillColumns(id) {
        ...
        columnId = columnId.substring(4, id.length);    <%-- for e.g. suppose id is t1c3 we want characters after t1c i.e beginIndex = 3. --%>
        ...
        document.getElementById("id").value= document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        document.getElementById("user_name").value = document.getElementById(t1id +(lowerLimit+2)).innerHTML;
        document.getElementById("user_password").value = document.getElementById(t1id +(lowerLimit+3)).innerHTML;
        document.getElementById("sendto").value = document.getElementById(t1id +(lowerLimit+4)).innerHTML;
    ...
    function displayMapList(id){
        ...
        popupwin = openPopUp(url, "Email Map Details", 500, 1000);
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>EMAIL</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="EmailController">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Sender Email</th>
                                                <td><input class="input" type="text" id="searchEmail" name="searchEmail" value="${searchEmail}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="EmailController">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            <tr>
                                                <th class="heading">S.No.</th>
                                                <th class="heading">Sender Email</th>
                                                <th  class="heading">Password</th>
                                                <th  class="heading">Reciever Email</th>
                                            </tr>
                                            <!---below is the code to show all values on jsp page fetched from taxTypeList of TaxController     --->
                                            <c:forEach var="EmailBean" items="${requestScope['emailList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${EmailBean.id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${EmailBean.user_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${EmailBean.user_password}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${EmailBean.sendto}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="get" action="EmailController" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Sender Email<span class="required_field_class">*</span></th>
                                                <td>
                                                    <input class="unique" type="hidden" id="id" name="id"  value="" >
                                                    <input class="unique" type="text" id="user_name" name="user_name" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Password</th><td><input class="input" type="password" id="user_password" name="user_password" value="" size="40" disabled></td>
                                            </tr>
                                             <tr>
                                                <th class="heading1">Reciever Email</th><td><input class="input" type="text" id="sendto" name="sendto" value="" size="40" disabled></td>
                                            </tr
