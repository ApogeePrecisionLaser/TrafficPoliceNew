...
//                $("span").css("display", "inline").fadeOut(2000);
    ...
    jQuery(function(){
        $("#searchStatusType").autocomplete("statusTypeCont", {
            extraParams: {
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="statusTypeCont">
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="get" action="statusTypeCont" onsubmit="return verify()">
