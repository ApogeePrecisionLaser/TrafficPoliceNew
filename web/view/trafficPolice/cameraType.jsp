<%-- 
    Document   : cameraType
    Created on : Apr 10, 2019, 10:35:07 AM
    Author     : Shobha
--%>
...
//                $("span").css("display", "inline").fadeOut(2000);
    ...
    jQuery(function(){
        $("#searchPaymentType").autocomplete("CameraTypeCont.do", {
            extraParams: {
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Camera Type</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="post" action="CameraTypeCont.do">
...
<!--                                                <td><input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList(id)"></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="post" action="CameraTypeCont.do">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="statusTypeBean" items="${requestScope['statusTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${statusTypeBean.camera_type_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${statusTypeBean.camera_type}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="CameraTypeCont.do" onsubmit="return verify()">
