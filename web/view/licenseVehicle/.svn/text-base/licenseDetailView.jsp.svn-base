                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="retrieve" items="${requestScope['licenseDetailList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)" >${retrieve.address}</td>
                                        ...
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="input new_input" type="text" id="owner_name" name="owner_name" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Age</th>
                                                <td><input class="input" type="number" id="age" name="age" value="" size="40" disabled></td>
                                            ...
                                            <tr>
                                                <th class="heading1">Issue Date</th><td><input class="input" type="text" id="issue_date" name="issue_date" value="" maxlength="10" size="40" disabled></td>
                                                <th class="heading1">Validity</th><td><input class="input" type="text" id="validity" name="validity" value="" maxlength="10" size="40" disabled></td>
                                            </tr>
