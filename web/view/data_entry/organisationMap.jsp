                                        ...
                                        <DIV>
                                            <table  border="0" id="table2" align="center"  class="content" width="750">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="heading1">Organization Type<span class="required_field_class">*</span></th><td><input class="input" id="org_type_name" name="org_type_name" value="" size="30" disabled></td>
                                                </tr>
                                                <tr>
                                                    <th class="heading1">Organization SubType<span class="required_field_class">*</span></th><td><input class="input" id="organisation_sub_type_name" name="organisation_sub_type_name" value="" size="30" disabled></td>
