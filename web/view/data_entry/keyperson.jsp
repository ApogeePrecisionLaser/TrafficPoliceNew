        ...
        <script type="text/javascript" language="javascript">
            jQuery(function(){
                ...
                $("#searchMobileNo").autocomplete("personCount.do", {
                    extraParams: {
                        action1: function() { return "searchMobileNo"}
                    }
                });
            ...
            function makeEditable(id) {
                ...
                if(id == 'new') {
                    ...
                    setDefaultColordOrgn(document.getElementById("noOfRowsTraversed").value, 19);
            ...
            function fillColumnKeyPerson(id) {
                ...
                document.getElementById("designation").value = document.getElementById(t1id +(lower+8)).innerHTML;
                document.getElementById("address_line1").value = document.getElementById(t1id +(lower+9)).innerHTML;
                document.getElementById("address_line2").value = document.getElementById(t1id +(lower+10)).innerHTML;
                document.getElementById("address_line3").value = document.getElementById(t1id +(lower+11)).innerHTML;
                document.getElementById("city_name").value = document.getElementById(t1id +(lower+12)).innerHTML;;
                document.getElementById("state_name").value = document.getElementById(t1id +(lower+13)).innerHTML;
                document.getElementById("mobile_no1").value = document.getElementById(t1id +(lower+14)).innerHTML;
                document.getElementById("mobile_no2").value = document.getElementById(t1id +(lower+15)).innerHTML;
                document.getElementById("landline_no1").value = document.getElementById(t1id +(lower+16)).innerHTML;
                document.getElementById("landline_no2").value = document.getElementById(t1id +(lower+17)).innerHTML;
                document.getElementById("email_id1").value = document.getElementById(t1id +(lower+18)).innerHTML;
                document.getElementById("email_id2").value = document.getElementById(t1id +(lower+19)).innerHTML;
                document.getElementById("general_image_details_id").value = document.getElementById(t1id +(lower+20)).innerHTML;
...
//                    }
            ...
            function displayOrgnList(id){
                var queryString;
                var organisation=document.getElementById("searchOfficeCode").value;
               // alert(organisation);
//                var person_name=document.getElementById("searchKeyPerson").value;
//                var emp_id=document.getElementById("searchEmpCode").value;
//                var designation=document.getElementById("searchDesiganation").value;
                if(id == "viewPdf")
                    queryString = "task1=PRINTRecordList&organisation="+organisation;
                else
                    queryString = "task1=PRINTExcelList&organisation="+organisation;
                //alert(queryString);
                                        ...
                                        <table width="100%"  class="heading1" >
                                            ...
                                            <tr align="center">
                                                <td>
                                                    ...
                                                    Mobile No.<input class="input" type="text" id="searchMobileNo" name="searchMobileNo" value="${searchMobileNo}" size="20">
                                                </td>
                                            </tr>
                                            <tr align="center">
                                                <td>
                                                ...
                                                <c:forEach var="key" items="${requestScope['keyList']}"  varStatus="loopCounter">
                                                    <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" >
                                                            <input type="button" class="button" id="${loopCounter.count}" name="emp_code" value="Show Image" onclick="viewDemandNote(id)">
                                                        </td>
                                        ...
                                        <DIV >
                                            <table id="table2" class="content" border="0" align="center" style="width: 100%" >
                                              ...
                                              <%--  <tr>
                                                ...
                                                <td><input class="input" type="text" id="office_code" name="office_code"  size="28" disabled></td>
                                                <th class="heading1" >Office Name<span class="required_field_class">*</span></th>
                                                ...
                                                <tr>
                                                    <th class="heading1" >Salutation<span class="required_field_class">*</span> </th>
                                                    ...
                                                    <th class="heading1" >Person Name<span class="required_field_class">*</span></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="input new_input" type="text" id="address_line2" name="address_line2" value=""   size="30" disabled></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="heading1" >State<span class="required_field_class">*</span></th>
                                                    <td><input class="input new_input" type="text" id="state_name" name="state_name" value="" size="28"  disabled></td>
                                                    <th class="heading1" >City<span class="required_field_class">*</span></th>
                                                    <td><input class="input new_input" type="text" id="city_name" name="city_name"  size="30" value="" disabled></td>
                                                     <th class="heading1" >Mobile No. 1st<span class="required_field_class">*</span></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="input" type="text" id="mobile_no2" name="mobile_no2" value=""  size="28" maxlength="10" disabled></td>
                                                    <th class="heading1" >LandLine No. 1st</th>
                                                    <td><input class="input" type="text" id="landline_no1" name="landline_no1" value=""  size="30"  disabled></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="input" type="text" id="email_id2" name="email_id2" value=""  size="28"  disabled></td>
