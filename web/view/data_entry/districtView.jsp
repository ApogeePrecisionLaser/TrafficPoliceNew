                ...
                <td colspan="2" align="center"><br style="line-height: 6px;">
                    ...
                    <form action="districtTypeCont" method="post" name="form2" onsubmit="return varification()">
                        <table class="content" border="1" align="center">
                            ...
                            <tr>
                                <td class="heading1" width="150">District Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" id="districtName" name="districtName" size="40" disabled/></td>
                            </tr>
                            <tr>
