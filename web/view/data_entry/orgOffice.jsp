        ...
        <script type="text/javascript" language="javascript">
            ...
            function makeEditable(id) {                
                ...
                if(id == 'new') {
                    ...
                    setDefaultColordOrgn(document.getElementById("noOfRowsTraversed").value, 18);
            ...
            function fillColumns(id) {
                ...
                document.getElementById("email_id1").value = document.getElementById(t1id +(lower+10)).innerHTML;
                document.getElementById("email_id2").value = document.getElementById(t1id +(lower+11)).innerHTML;
                document.getElementById("mobile_no1").value = document.getElementById(t1id +(lower+12)).innerHTML;
                document.getElementById("mobile_no2").value = document.getElementById(t1id +(lower+13)).innerHTML;
                document.getElementById("landline_no1").value = document.getElementById(t1id +(lower+14)).innerHTML;
                document.getElementById("landline_no2").value = document.getElementById(t1id +(lower+15)).innerHTML;
                document.getElementById("landline_no3").value = document.getElementById(t1id +(lower+16)).innerHTML;
                                        ...
                                        <DIV>
                                            <table id="table2" border="0" align="center" class="content">
                                                <tr id="message">
                                                 ...
                                                 <tr>
                                                    <th class="heading1" >Organization Name<span class="required_field_class">*</span></th>
                                                    <td>
                                                     ...
                                                     <th class="heading1">Office Type<span class="required_field_class">*</span></th>
                                                ...
                                                <tr>
                                                     <th class="heading1" nowrap>Office Name<span class="required_field_class">*</span></th>
                                                    <td><input class="input new_input" type="text" id="org_office_name" name="org_office_name" value="" disabled></td>

                                                    <th class="heading1" nowrap>Address Line1<span class="required_field_class">*</span></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="heading1">State Name<span class="required_field_class">*</span></th>
                                                    <td><input class="input new_input" type="text" id="state_name" name="state_name" value="" disabled></td>

                                                    <th class="heading1">City Name<span class="required_field_class">*</span></th>
                                                    <td><input class="input new_input" type="text" id="city_name" name="city_name" value="" disabled></td>
                                                    
                                                </tr>
                                                <tr>
                                                    <th class="heading1">First EmailID<span class="required_field_class">*</span></th>
                                                    ...
                                                    <th class="heading1">Landline No1<span class="required_field_class">*</span></th>
