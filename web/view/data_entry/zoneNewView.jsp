                    ...
                    <div align="center">
                        <form action="zoneTypeCont" method="post" name="form2" onsubmit="return varification()">
                            <table class="content" border="1" align="center">
                                ...
                                <tr>
                                    <td class="heading1" width="210px;">City Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" name="CityName" id="CityName" value="" size="30" disabled></td>
                                    <td class="heading1">Zone Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" name="zoneName" id="zoneName" value="" size="30" disabled></td>
                                </tr>
                                <tr>
