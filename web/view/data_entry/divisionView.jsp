        ...
        <div align="center">
            <form action="divisionTypeCont" method="post" name="form2" onsubmit="return varification()">
                <table class="content" border="1" align="center">                    
                     ...
                     <tr>
                        <td class="heading1">Zonal Council<span class="required_field_class">*</span></td>
<!--                        <td><input type="text" name="zoneName" id="zoneName" value="" size="40" disabled></td>-->
                    
                     <td><select class="dropdown" id="zoneName" name="zoneName">
                     ...
                     <tr>
                        <td class="heading1">State Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" name="stateName" id="stateName" value="" size="40" disabled></td>
                    </tr>
                    <tr>
                        <td class="heading1">UT Name</td><td><input type="text" class="new_input" name="utName" id="utName" value="" size="40" disabled></td>
                    </tr>
                    <tr>
                        <td class="heading1" width="150">Division Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" id="divisionName" name="divisionName" size="40" disabled/></td>
                    </tr>
                    <tr>
