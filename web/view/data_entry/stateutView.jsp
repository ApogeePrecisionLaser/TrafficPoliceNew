        ...
        <div align="center">
            <form action="stateutTypeCont" method="post" name="form2" onsubmit="return varification()">
                ...
                <table class="content" border="1" align="center">
                     ...
                     <tr>
                         <td class="heading1">Country Name<span class="required_field_class">*</span></td><td><input type="text" name="countryName" id="countryName" value="India" size="40" readonly></td>
                    </tr>
                     <tr>
<!--                        <td class="heading1">Zone Name</td><td><input type="text" name="zoneName" id="zoneName" value="" size="40" disabled></td>-->
                    
                     <td class="heading1" >Zone Name <span class="required_field_class">*</span></td>
                                                <td>
                                                    <select class="dropdown" id="zoneName" name="zoneName">
                    ...
                    <tr>
                        <td class="heading1" width="150">State Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" id="stateName" name="stateName" size="40" disabled/></td>
                    </tr>
                    <tr>
