                                ...
                                <form name="searchForm" id="searchForm" action="orgDetailEntryCont.do" method="post" onsubmit="return verifySearch()">
                                    <table class="header_table" width="100%">
                                        <tr align="center">
                                            ...
                                            <td>                                                
                                                Organization-<input type="text" class="input" name="searchOrganisation" id="searchOrganisation" value="${searchOrganisation}" size="40">
                                ...
                                <td>
                                    <table id="table2" align="center"  border="1"  class="content" width="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="input" id="organisation" name="organisation" value="${orgDetail.organisation}" size="30" onkeyup="removeErrorField(id)" disabled>
                                            </td>
                                            <th class="heading1" >Organization Type</th>
                                            <td>
                                                <input type="text" class="input" id="org_type_name" name="org_type_name" value="${orgDetail.org_type_name}" size="25" disabled>
                                            </td>
                                            <th class="heading1" >Org Sub Type</th>
                                            <td>
                                                <input type="text" class="input" id="org_sub_type" name="org_sub_type" value="${orgDetail.org_sub_type}" size="25"  disabled>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table id="table3" align="center"  border="1"  class="content" width="100%">
                                        <tr>
                                            <th class="heading1">Office Type</th><td><input type="text" class="input" id="office_type" name="office_type" value="${orgDetail.office_type}" size="30" onkeyup="removeErrorField(id)" disabled></td>
                                            <th class="heading1">Office Code</th><td><input type="text" class="input" id="office_code" name="office_code" value="${orgDetail.office_code}" size="30" onkeyup="removeErrorField(id)" disabled></td>                                          
                                                                      ...
                                                                      <tr>
                                                                          <th class="heading1">Office Name</th><td><input type="text" class="input" id="office_name" name="office_name" value="${orgDetail.office_name}" size="30" onkeyup="removeErrorField(id)" disabled></td>
                                            <th class="heading1">City(Office)</th><td><input type="text" class="input" id="office_city" name="office_city" value="${orgDetail.office_city}" size="30" onkeyup="removeErrorField(id)" disabled></td>
              
                                                                      </tr>
                                        <tr>
                                            <th class="heading1">Address1</th><td colspan="5"><input type="text" class="input" id="office_address1" name="office_address1" value="${orgDetail.office_address1}" size="90" onkeyup="removeErrorField(id)" onfocus="removeErrorField(id)" disabled></td>
                                        </tr>
                                        <tr>
                                            <th class="heading1">Address2</th><td colspan="5"><input type="text" class="input" id="office_address2" name="office_address2" value="${orgDetail.office_address2}" size="90" onkeyup="removeErrorField(id)" onfocus="removeErrorField(id)" disabled></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                    ...
                                    <table id="table3" align="center" border="1"  class="content" width="100%">
                                        <tr>
                                            ...
                                            <th class="heading1">Person Name</th><td nowrap>
                                                ...
                                                <input type="text" class="input" id="key_person" name="key_person" value="${orgDetail.keyperson}" size="30" onkeyup="removeErrorField(id)" disabled></td>
                                            
                                                  </tr>
                                                  <tr> <th class="heading1">Designation</th><td><input type="text" class="input" id="designation" name="designation" value="${orgDetail.designation}"  size="25" onkeyup="removeErrorField(id)" disabled></td>
                                        ...
                                        <tr>
                                            <th class="heading1">Address1</th><td colspan="3"><input type="text" class="input" id="person_address1" name="person_address1" value="${orgDetail.person_address1}" size="60" onkeyup="removeErrorField(id)" onfocus="removeErrorField(id)" disabled></td>
                                             <th class="heading1">City(Person)</th><td><input type="text" class="input" id="person_city" name="person_city" value="${orgDetail.person_city}" size="25" onkeyup="removeErrorField(id)" disabled></td>
                                              </tr>
                                              <tr>
                                            <th class="heading1">Address2</th><td colspan="5"><input type="text" class="input" id="person_address2" name="person_address2" value="${orgDetail.person_address2}" size="60" onkeyup="removeErrorField(id)" onfocus="removeErrorField(id)" disabled></td>
                                              </tr>
                                    </table>
                                </td>
                            </tr>
