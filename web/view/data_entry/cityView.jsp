...
//                }
            ...
            function findfill(id)
            {
                ...
                document.getElementById('cityDescription').value = document.getElementById(id+'4').innerHTML;
                document.getElementById('divisionName').value=document.getElementById(id+'6').innerHTML;
                document.getElementById('districtName').value=document.getElementById(id+'5').innerHTML;
                document.getElementById('message').innerHTML="";                 
            }
            function setDefault()
            {
                ...
                <td colspan="2" align="center"><br style="line-height: 6px;">
                    ...
                    <form action="cityTypeCont" method="post">
                        ...
                        <table id="table1" border="1" align="center"  class="reference">
                            <tr>
                                ...
                                <th class="heading" id="changeCityFont">City Name</th>
                                <th class="heading">City Description</th>
                                <td class="heading" id="changeDistrictFont">District Name</td>
                                <td class="heading" id="changeDivisionFont">Division Name</td>
                            </tr>
                            <c:forEach var="cityBean" items="${requestScope['cityList']}" varStatus="loopcounter">
                                <tr id="${loopcounter.count}"onclick="findfill(id)">
                                    ...
                                    <td class="new_input" id="${loopcounter.count}4">${cityBean.cityDescription}</td>
                                    <td class="new_input district_name" id="${loopcounter.count}5">${cityBean.districtName}</td>
                                    <td class="new_input division_name" id="${loopcounter.count}6">${cityBean.divisionName}</td>
                                </tr>
                            </c:forEach>
                            <tr>
                    ...
                    <form action="cityTypeCont" method="post" name="form2" onsubmit="return varification()">
                        <table class="content" border="1" align="center">
                            ...
                            <tr>
                                <td class="heading1">Division Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" name="divisionName" id="divisionName" value="" size="40" disabled /></td>
                            </tr>
                            <tr>
                                <td class="heading1">District Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" name="districtName" id="districtName" value="" size="40" disabled></td>
                            </tr>
                            <tr>
                                <td class="heading1" width="150">City Name<span class="required_field_class">*</span></td><td><input type="text" class="new_input" id="cityName" name="cityName" size="40" disabled/></td>
                            </tr>
                            <tr>
