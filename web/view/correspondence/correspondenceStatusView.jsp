<%-- 
    Document   : correspondenceStatusView
...
<script type="text/javascript" language="javascript">
    var doc = document;
    jQuery(function(){
        $("#searchStatusType").autocomplete("correspondenceStatusCont.do", {
            extraParams: {
    ...
    function makeEditable(id) {
        doc.getElementById("status_type").disabled = false;
        doc.getElementById("remark").disabled = false;
        doc.getElementById("correspondence_type").disabled = false;
        ...
        if(id == 'new') {
            ...
            doc.getElementById("status_type_id").value = 0;
            setDefaultColor(doc.getElementById("noOfRowsTraversed").value, 5);
            doc.getElementById("status_type").focus();
    ...
    function verify() {
        ...
        if(doc.getElementById("clickedButton").value == 'Save' || doc.getElementById("clickedButton").value == 'Save AS New') {
            ...
            var status_type = doc.getElementById("status_type").value;
    ...
    function fillColumns(id) {
        ...
        doc.getElementById("status_type_id").value= doc.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        var correspondence_type = doc.getElementById(t1id +(lowerLimit+2)).innerHTML;
        $("#correspondence_type option:contains(" + correspondence_type + ")").attr('selected', 'selected');
        doc.getElementById("status_type").value = doc.getElementById(t1id +(lowerLimit+3)).innerHTML;
    ...
    function displayMapList(){
        ...
        var url = "correspondenceStatusCont.do?"+queryString;
...
<html>
    <head>
        ...
        <title>Correspondence Status</title>
    </head>
    <body>
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Correspondence Status</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="correspondenceStatusCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                ...
                                                <th class="heading1">Correspondence Type</th>
                                                <td>
                                                    <select id="searchCorrespondenceType" name="searchCorrespondenceType" >
                                                        <option value="">Select..</option>
                                                        <c:forEach var="corres_list" items="${correspondenceTypeList}" >
                                                            <option value="${corres_list.value}"  ${searchCorrespondenceType == corres_list.value ? 'selected' : ''}>${corres_list.value}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td><td><input class="button" type="submit" name="task" id="searchIn" value="Search"></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="correspondenceStatusCont.do">
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="statusTypeBean" items="${requestScope['statusTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${statusTypeBean.correspondence_status_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${statusTypeBean.correspondence_type}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" >${statusTypeBean.status}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="correspondenceStatusCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Correspondence Type</th>
                                                <td>
                                                    <select id="correspondence_type" name="correspondence_type" disabled>
                                                        <c:forEach var="corres_list" items="${correspondenceTypeList}" >
                                                            <option value="${corres_list.key}">${corres_list.value}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
