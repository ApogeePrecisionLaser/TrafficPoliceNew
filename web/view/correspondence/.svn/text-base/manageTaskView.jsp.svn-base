    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            jQuery(function(){
                ...
                $("#search_task").autocomplete("taskSchedulerCont.do", {
                    extraParams: {
...
//                changeStatus();
            ...
            function getRecord(id){
                        ...
                        var url = "taskSchedulerCont.do?" + queryString + "&search_corr_no="+search_corr_no+"&search_task="+search_task;
                    ...
                    <DIV id="body" class="maindiv">
                        <table>
                            <tr><td>
                                    <table>
                                        <tr>
                                            <td align="center" class="header_table" width="90%">Task Manager</td>
                            ...
                            <tr>
                                <td>
                                    <form name="form0" method="POST" action="taskSchedulerCont.do">
                            ...
                            <tr><td align="center">
                                    <div class="content_div">
                                        <form name="form1" method="POST" action="taskSchedulerCont.do" >
                                            <table border="1" id="table1"   class="content" width="900" >
                                                <tr>
                                                    <th class="heading">S.No.</th>
                                                    <th class="heading">Corr. No</th>
                                                    <th class="heading" colspan="4">Subject</th>
                                                ...
                                                <c:forEach var="corresBean" items="${requestScope['correcpondencelist']}" varStatus="loopCounter">                                                  
                                                    <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}"  style="background-color: lightgray; ">
                                                        <td onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}
                                                        ...
                                                        <td>${corresBean.correspondece_no}</td>
                                                        <td colspan="4">${corresBean.subject}</td>
                                                    ...
                                                    <c:forEach var="taskList" items="${corresBean.taskList}" varStatus="loopCounter">
                                                        <c:set var="rowCount" scope="page" value="${rowCount + 1}"/>
                                                        <tr>
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${loopCounter.count}
                                                                <input type="hidden" id="correspondence_id${rowCount}" value="${corresBean.correcpondence_id}">
                                                                <input type="hidden" id="correspondence_no${rowCount}" value="${corresBean.correspondece_no}">
                                                                <input type="hidden" id="correcpondence_task_id${rowCount}" value="${taskList.correspondence_task_id}">
                                                                <input type="hidden" id="revision${rowCount}" value="${taskList.revision}">
                                                            </td>
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${taskList.task}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${taskList.start_date}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${taskList.no_of_days}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${taskList.remark}</td>
                                                            <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${taskList.status}</td>                                                            
                                                        </tr>
                                                    </c:forEach>
                                                </c:forEach>                                            
                                                <tr>
                            ...
                            <tr>
                                <td align="center" >
                                    <div>                                       
                                        <form id="form4" name="form4" method="POST" action="taskSchedulerCont.do" onsubmit="return verify()">
                                            <table border="0" id="table2" align="center" class="content" width="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="input" size="50" id="correspondence_task" name="correspondence_task" value=""></td>
                                                </tr>
                                                <tr>
                                                    <th class="heading1">Date Apply From</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="input" id="remark" name="remark" value=""></td>
                                                    <th class="heading1">Status</th>
                                                    <td>
                                                        <input type="text" class="" id="task_status" name="task_status" value="">
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td align='center' colspan="6" >
                                                        ...
                                                        <input class="button" type="submit" name="task" id="reply" value="Reply" onclick="setStatus(id)" disabled>
                                                    </td>
                                                </tr>
