...
<script type="text/javascript" language="javascript">
    var doc = document;
    jQuery(function(){
        $("#searchPriority").autocomplete("correspondencePriorityCont.do", {
            extraParams: {
    ...
    function makeEditable(id) {
        ...
        if(id == 'new') {
            ...
            doc.getElementById("correspondence_priority_id").value = 0;
            setDefaultColor(doc.getElementById("noOfRowsTraversed").value, 4);
            doc.getElementById("priority").focus();
        }
        if(id == 'edit'){
    ...
    function fillColumns(id) {
        ...
        doc.getElementById("correspondence_priority_id").value= doc.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        doc.getElementById("priority").value = doc.getElementById(t1id +(lowerLimit+2)).innerHTML;
    ...
    function displayMapList(){
        ...
        var url = "correspondencePriorityCont.do?"+queryString;
...
<html>
    <head>
        ...
        <title>Correspondence Priority</title>
    </head>
    <body>
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Correspondence Priority</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="correspondencePriorityCont.do">
                                        <table align="center" class="heading1" width="600">
                                            <tr>
                                                <th>Priority</th>
                                                <td><input class="input new_input" type="text" id="searchPriority" name="searchPriority" value="${searchPriority}" size="30" ></td>
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="correspondencePriorityCont.do">
                                    <DIV class="content_div">    
                                        ...
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="priorityBean" items="${requestScope['priorityList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${priorityBean.correspondence_priority_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)" >${priorityBean.priority}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)">${priorityBean.remark}</td>
                                                </tr>                                               
                                            </c:forEach>
                                            <tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="correspondencePriorityCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="input" type="hidden" id="correspondence_priority_id" name="correspondence_priority_id" value="" >
                                                    <input class="input new_input" type="text" id="priority" name="priority" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Description</th><td><input class="input new_input" type="text" id="remark" name="remark" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
