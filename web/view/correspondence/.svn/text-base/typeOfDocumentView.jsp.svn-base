...
<script type="text/javascript" language="javascript">
    var doc = document;
    jQuery(function(){
        $("#searchRemark").autocomplete("typeOfDocumentCont.do", {
            extraParams: {
    ...
    function makeEditable(id) {
        ...
        if(id == 'new') {
            ...
            doc.getElementById("type_of_document").value = 0;
            setDefaultColor(doc.getElementById("noOfRowsTraversed").value, 4);
            doc.getElementById("type_of_document").focus();
        }
        if(id == 'edit'){
    ...
    function verify() {
        ...
        if(doc.getElementById("clickedButton").value == 'Save' || doc.getElementById("clickedButton").value == 'Save AS New') {
            ...
            var remark = doc.getElementById("type_of_document").value;

            if(myLeftTrim(remark).length == 0) {

                doc.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>Reason is required...</b></td>";
                $("#message").html("<td colspan='5' bgcolor='coral'><b>Document Type is required...</b></td>");
                doc.getElementById("type_of_document").focus();
    ...
    function fillColumns(id) {
        ...
        doc.getElementById("type_of_document_id").value= doc.getElementById(t1id + (lowerLimit + 0)).innerHTML;
        doc.getElementById("type_of_document").value = doc.getElementById(t1id +(lowerLimit+2)).innerHTML;
    ...
    function displayMapList(){
        ...
        var url = "typeOfDocumentCont.do?"+queryString;
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Document Type</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="typeOfDocumentCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="typeOfDocumentCont.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="600"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="docTypeBean" items="${requestScope['DocumentTypeList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${docTypeBean.type_of_document_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)" >${docTypeBean.type_of_document}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" class="new_input" onclick="fillColumns(id)">${docTypeBean.description}</td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="typeOfDocumentCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Document Type</th>
                                                <td>
                                                    <input class="input" type="hidden" id="type_of_document_id" name="type_of_document_id" value="" >
                                                    <input class="input new_input" type="text" id="type_of_document" name="type_of_document" value="" size="40" disabled>
                                                </td>
                                            </tr>
                                            <tr>
