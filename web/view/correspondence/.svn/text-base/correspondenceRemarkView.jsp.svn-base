...
<script type="text/javascript" language="javascript">
    var doc  = document;
    jQuery(function(){
        $("#searchRemark").autocomplete("correspondenceRemarkCont.do", {
            extraParams: {
    ...
    function displayMapList(){
        ...
        var url = "correspondenceRemarkCont.do?"+queryString;
...
<html>
    <head>
        ...
        <title>Correspondence Reason</title>
    </head>
    <body>
                ...
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Correspondence Reason</b></td>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="correspondenceRemarkCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="correspondenceRemarkCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="correspondenceRemarkCont.do" onsubmit="return verify()">
