...
//                    }
//                });
                $("#searchReceiptNo").autocomplete("receiptBookCont.do", {
                    extraParams: {
                        action1: function() { return "getReceiptNoSearchList"},
                        receipt_book_no: function(){return doc.getElementById("searchReceiptBookNo").value ;}
                    }
                });
...
//            alert('GpsGate started');
            ...
            function verify(){debugger;
                var result = true;
                var receipt_book_no = $("#receipt_book_no").val();
                               ...
                               <tr id="message">
                                ...
                                <tr align="">                                 
                                    ...
                                    <td id="offence_td" align="">
                                        <div class="form-group" id="" align="center">
                                            ...
                                            <input type="text" class="ac_input" id="searchReceiptBookNo" value="${searchReceiptBookNo}" onkeypress="IsNumeric(id)" onkeyup="IsNumeric(id)" onclick="IsNumeric(id)" onblur="IsNumeric(id)" name="searchReceiptBookNo">
                                            <input type="hidden" id="receipt_book_revision" value="" name="receipt_book_revision">
                                            <label for="receipt_no">Receipt No.</label>
                                            <input type="text" class="ac_input" id="searchReceiptNo" value="${searchReceiptNo}" onblur="" name="searchReceiptNo">
                                            <input type="submit" class="btn" id="search" name="task" value="Search">
                                        </div>
                                        <div class="form-group" id="">
                                            
                                        </div>
                                        <div class="form-group" id="" style="display: none" align="center">
                                ...
                                <div id="resultTable" class="form-group jumbotron table-responsive" style="">
                                            <table class="table table-condensed table-hover table-bordered">
                                                <c:forEach var="receiptBean" items="${requestScope['receiptList']}" varStatus="loopCounter">                                                    
                                                <thead>
                                                    <tr>
                                                        <th>${lowerLimit - noOfRowsTraversed + loopCounter.count}</th>
                                                        <td colspan="3" align="center"><b>Receipt Book No.:</b>
                                                        ${receiptBean.receipt_book_no}
                                                        <b>&nbsp;&nbsp;Receipt No.:</b>
                                                        ${receiptBean.page_no}
                                                        </td>
                                                    </tr>
                                                ...
                                                <tbody id="receipt_table_body">
                                                    ...
                                                    <c:forEach var="receiptList" items="${receiptBean.receiptBookRecords}" varStatus="loopCounter">
                                                        <c:set var="rowCount" scope="page" value="${rowCount + receiptList.amount}"/>
                                                        <tr>
                                                            <td>${loopCounter.count}</td>
                                                            <td>${receiptList.challan_book_no}</td>
                                                            <td>${receiptList.challan_no}</td>
                                                            ...
                                                            <td align='center' colspan="15">
                                                                <c:choose>
                                                                    <c:when test="${showFirst eq 'false'}">
                                                                        <input type='submit'class="btn" name='buttonAction' value='First' disabled>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type='submit' class="btn" name='buttonAction' value='First'>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                                <c:choose>
                                                                    <c:when test="${showPrevious == 'false'}">
                                                                        <input type='submit'class="btn" name='buttonAction' value='Previous' disabled>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type='submit' class="btn" name='buttonAction' value='Previous'>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                                <c:choose>
                                                                    <c:when test="${showNext eq 'false'}">
                                                                        <input type='submit' class="btn" name='buttonAction' value='Next' disabled>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type='submit'class="btn" name='buttonAction' value='Next'>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                                <c:choose>
                                                                    <c:when test="${showLast == 'false'}">
                                                                        <input type='submit'class="btn" name='buttonAction' value='Last' disabled>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <input type='submit'class="btn" name='buttonAction' value='Last'>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </td>
                                                        </tr>
