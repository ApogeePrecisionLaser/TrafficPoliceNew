...
<script type="text/javascript" language="javascript">
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') 
        {
            ...
            if(myLeftTrim(zone_name).length == 0) {
                alert(zone_name);
            ...
            //var area_no = document.getElementById("area_no").value;
            if(myLeftTrim(area_no).length == 0) {
                $("#message").html("<td colspan='2' bgcolor='coral'><b>Area No. is required...</b></td>");
                document.getElementById("area_no").focus();
                return false; // code to stop from submitting the form2.
            }
            if(result == false) {
                                    ...
                                    <DIV>
                                        <form name="form2" method="POST" action="areaTypeCont" onsubmit="return verify()">
                                            <table  border="0" id="table2" align="center" width="600" class="content">
                                                ...
                                                <tr>
                                                    <th class="heading1">Area Name<span class="required_field_class">*</span></th>
                                                    ...
                                                    <th class="heading1">Area No<span class="required_field_class">*</span></th>
                                                    <td>
