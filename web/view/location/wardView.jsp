                                ...
                                <div>
                                    <form name="form2" method="POST" action="wardTypeCont" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                <th class="heading1">Zone Name<span class="required_field_class">*</span></th>
                                                <td>
                                            ...
                                            <tr>
                                                <th class="heading1">Ward Name<span class="required_field_class">*</span></th>
                                                <td><input class="new_input" type="text" id="ward_name" name="ward_name" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Ward No<span class="required_field_class">*</span></th>
