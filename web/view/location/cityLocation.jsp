...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        ...
        $("#searchZone").focus(function(){
                    ...
                    sheet.innerHTML = ".ac_results li {font-family: 'kruti Dev 010'; font-size: 16px;}";
...
//                $("span").css("display", "inline").fadeOut(2000);
      ...
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
        ...
        $("#zone").autocomplete("cityLocationCont.do", {
            extraParams: {
                action1: function() { return "getZone"}
            }
        });

               $("#ward").autocomplete("cityLocationCont.do", {
            extraParams: {
            ...
            $("#area").autocomplete("cityLocationCont.do", {
            extraParams: {
...
//                    $("#searchLocation").click(cssFunction);
    ...
    function verify() {
        ...
        if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') 
        {
            ...
            var location_no =   document.getElementById("location_no").value;
            
            if(myLeftTrim(zone).length == 0) {
                //alert(zone_name);
                $("#message").html("<td colspan='2' bgcolor='coral'><b>Zone  Name  is required...</b></td>");
                document.getElementById("zone").focus();
            ...
            if(myLeftTrim(ward).length == 0) {
                $("#message").html("<td colspan='2' bgcolor='coral'><b>Ward  is required...</b></td>");
                document.getElementById("ward").focus();
                return false; // code to stop from submitting the form2.
            }
            if(myLeftTrim(area).length == 0) {
...
//            }
            ...
            if(myLeftTrim(location_no).length == 0) {
                $("#message").html("<td colspan='2' bgcolor='coral'><b>Location No. is required...</b></td>");
                document.getElementById("location_no").focus();
                return false; // code to stop from submitting the form2.
            }
            if(result == false) {
    ...
    function fillColumns(id)
    {
        ...
        document.getElementById("city_name_english").value = document.getElementById(t1id +(lowerLimit+6)).innerHTML;
         ...
         document.getElementById("location_no").value = document.getElementById(t1id +(lowerLimit+7)).innerHTML;
    ...
    function openMapForCord() {
        var url="cityLocationCont.do?task=GetCordinates1";//"getCordinate";
            ...
            <td>
                <DIV id="body" class="maindiv" align="center" >
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="get" action="cityLocationCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="get" action="cityLocationCont.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="700"  border="1"  align="center" class="content">
                                            <tr>
                                                ...
                                                <th class="heading">City Location(H)</th>
                                            ...
                                            <c:forEach var="cityLocationBean" items="${requestScope['cityLocationList']}"  varStatus="loopCounter">
                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}" class="input" onclick="fillColumns(id)">${cityLocationBean.city_eng}</td>
                        ...
                        <tr>
                            <td align="center">
                                <div>
                                    <form name="form2" method="post" action="cityLocationCont.do" onsubmit="return verify()">
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr> <th class="heading1">Zone<span class="required_field_class">*</span></th><td><input class="new_input" type="text" id="zone" name="zone" value="" size="20" disabled></td>
                                             <th class="heading1">Ward<span class="required_field_class">*</span></th><td><input class="new_input" type="text" id="ward" name="ward" value="" size="20" disabled></td></tr>
                                            <tr>
                                                <th class="heading1">Area<span class="required_field_class">*</span></th><td><input class="new_input" type="text" id="area" name="area" value="" size="20" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">City Location(Hindi)<span class="required_field_class">*</span></th>
                                                <td>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <th class="heading1">Location No<span class="required_field_class">*</span></th><td><input class="input" type="text" id="location_no" name="location_no" value="" size="20" disabled></td>
